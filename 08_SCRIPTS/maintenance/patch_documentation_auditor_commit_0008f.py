"""
PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008F

Update the Audit Orchestrator smoke test to validate structured findings.
...
def validate_source(source: str) -> None:
    ...
    if missing:
        raise RuntimeError(
            "Smoke test is missing structured-finding checks: "
            f"{missing}"
        )
...
def main() -> int:
    ...
    if original == TEST_SOURCE:
        ...
        print("[OK] PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008F already applied.")
    ...
    print("[OK] PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008F applied successfully.")
    print(f"[OK] Updated: {TARGET}")

    if backup_path is not None:
        print(f"[OK] Backup: {backup_path}")

    print("[OK] Structured findings list validated.")
    print("[OK] Finding schema validated.")
    print("[OK] Finding codes validated.")
    print("[OK] Finding counters cross-validated.")
