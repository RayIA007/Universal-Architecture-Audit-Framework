"""
PATCH-CREATE-MODULE-INDEX-BUILDER-COMMIT-0014E

Insert the first part of the exact Commit 0014 NEW_SOURCE into the incremental
Commit 0014 generator.

This part defines the updated plugin contract, deterministic Python discovery,
context validation, and the call into the module index builder. It does not
analyze Python source contents.
"""
...
ANCHOR = "# PATCH-0014E-NEW-SOURCE-PART-1-ANCHOR"

REPLACEMENT = """NEW_SOURCE_PART_1 = {part!r}
...
def main() -> int:
    if not TARGET.is_file():
        ...
        print("[ERROR] Apply patches 0014A through 0014D before patch 0014E.")
        return 1

    original = TARGET.read_text(encoding="utf-8")

    if "# PATCH-0014E-APPLIED" in original:
        print("[OK] Patch 0014E already applied.")
        return 0

    if "# PATCH-0014D-APPLIED" not in original:
        print("[ERROR] Patch 0014D has not been applied.")
        return 1

    occurrences = original.count(ANCHOR)
    if occurrences != 1:
        print(
            "[ERROR] Expected exactly one 0014E NEW_SOURCE part 1 anchor "
            f"occurrence, found {occurrences}."
        )
        return 1
    ...
    print("[OK] PATCH-CREATE-MODULE-INDEX-BUILDER-COMMIT-0014E applied successfully.")
    print(f"[OK] Backup: {backup_file}")
    print("[OK] Commit 0014 NEW_SOURCE part 1 added.")
    print("[OK] No Python source-content analysis introduced.")
    print("[OK] AST validation passed.")
    print("[OK] Compilation validation passed.")
    print("[NEXT] Apply patch 0014F.")
