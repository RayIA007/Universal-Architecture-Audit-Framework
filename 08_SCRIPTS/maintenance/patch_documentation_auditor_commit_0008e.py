"""
PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008E

Add normalized, actionable finding records to the Documentation Auditor.
...
def validate_source(source: str) -> None:
    ...
    if missing_fragments:
        raise RuntimeError(
            "Documentation Auditor is missing finding fields: "
            f"{missing_fragments}"
        )
...
def main() -> int:
    ...
    if original == MODULE_SOURCE:
        ...
        print("[OK] PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008E already applied.")
    ...
    print("[OK] PATCH-DOCUMENTATION-AUDITOR-COMMIT-0008E applied successfully.")
    print(f"[OK] Updated: {TARGET}")

    if backup_path is not None:
        print(f"[OK] Backup: {backup_path}")

    print("[OK] Structured finding records added.")
    print("[OK] DOC_EMPTY_FILE finding code added.")
    print("[OK] DOC_MISSING_H1 finding code added.")
    print("[OK] Existing audit metrics preserved.")
