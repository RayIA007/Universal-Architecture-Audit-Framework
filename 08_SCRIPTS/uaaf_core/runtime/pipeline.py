...
class RuntimePipeline:
    ...
    def validate(
        ...
        return DependencyResolver.resolve(enabled_steps)
    ...
    def execute(
        ...
        with self._lock:
            ...
            for processor_id in ordered_ids:
                ...
                if PipelineDependencyGuard.should_skip(
                ...
                try:
                    result = PipelineExecutor.execute_processor(
                        context=context,
            ...
            PipelineCompletionHandler.complete(
                execution=execution,
